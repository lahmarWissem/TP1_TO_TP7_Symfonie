 ...
 */
public function home(Request $request,ArticleRepository $ArticleRepository,PersistenceManagerRegistry $doctrine)
{
 ...
 * Method({"GET", "POST"})
 */
 public function newCategory(Request $request,PersistenceManagerRegistry $doctrine) {
   ...
   return $this->render('Category/new.html.twig',['form'=>
   $form->createView()]);
    }
 ...
 */
 public function show($id,ArticleRepository $ArticleRepository,PersistenceManagerRegistry $doctrine) {
 ...
 * Method({"GET", "POST"})
 */
 public function edit(Request $request, $id,PersistenceManagerRegistry $doctrine) {
    $article = new Article();
 ...
 * @Method({"DELETE"})
 */
public function delete(Request $request, $id,PersistenceManagerRegistry $doctrine) {
    $article = $doctrine->getRepository(Article::class)->find($id);
 ...
 * Method({"GET", "POST"})
 */
 public function articlesParCategorie(Request $request,PersistenceManagerRegistry $doctrine) {
 ...
 * Method({"GET"})
 */
 public function articlesParPrix(Request $request,PersistenceManagerRegistry $doctrine)
 {
